                        ...
                        <div class="card h-100 post-card">
                            ...
                            <div class="card-footer bg-transparent">
                                <div class="action-buttons">
                                    ...
                                    <form action="SavePost" method="post" style="display:inline;">
            ...
            <c:if test="${endpage >= 1}">
                <nav aria-label="Page navigation example">
                    <ul class="pagination" style="display: flex;justify-content: center;align-items: center;">
                        <c:if test="${tag>1}">
                            <li class="page-item">
                                <a class="page-link" href="SavedPost?index=${tag-1}" aria-label="Previous">
                        ...
                        <c:forEach begin="1" end="${endpage}" var="i">
                            <li class="page-item ${tag==i ? 'active' : ''}">
                                <a class="page-link" href="SavedPost?index=${i}">${i}</a>
                            </li>
                        </c:forEach>
                        <c:if test="${tag<endpage}">
                            <li class="page-item">
                                <a class="page-link" href="SavedPost?index=${tag+1}" aria-label="Next">
